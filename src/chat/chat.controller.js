...
var ChatController = function () {
    var _classDecorators = [(0, common_1.Controller)('chat')];
    ...
    var ChatController = _classThis = /** @class */ (function () {
        ...
        ChatController_1.prototype.create = function (createChatDto) {
            return this.chatService.createChat(createChatDto);
        };
        ChatController_1.prototype.findAll = function (chatId) {
            return;
        };
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)('message')];
