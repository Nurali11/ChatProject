...
var ChatService = function () {
    ...
    var ChatService = _classThis = /** @class */ (function () {
        ...
        ChatService_1.prototype.createChat = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.prisma.chat.create({ data: data })];
                        case 1:
                            chat = _a.sent();
        ...
        ChatService_1.prototype.getChat = function (myId) {
            return __awaiter(this, void 0, void 0, function () {
                var chat;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.chat.findMany({
                                where: {
                                    OR: [
                                        { fromId: myId },
                                        { toId: myId }
        ...
        ChatService_1.prototype.deleteChat = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var chat, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.prisma.chat.delete({ where: { id: id } })];
                        case 1:
                            chat = _a.sent();
                            return [2 /*return*/, chat];
                        case 2:
